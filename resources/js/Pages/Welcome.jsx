                        ...
                        <main className="mt-6">
                            <div className="flex flex-col gap-4 max-w-xl items-start">
                                ...
                                <div className="flex gap-2">
                                    <a target="_blank" href="https://github.com/geekhadev/laravel-admin-template" className="text-sm text-balance text-orange-500 hover:text-orange-600">
                                        GitHub
                                    </a>
                                    <span className="text-sm text-balance text-gray-500">|</span>
                                    <a target="_blank" href="https://github.com/geekhadev/laravel-admin-template/blob/main/CONTRIBUTING.md" className="text-sm text-balance text-orange-500 hover:text-orange-600">
                                        ¿Cómo contribuir?
                                    </a>
                                    <span className="text-sm text-balance text-gray-500">|</span>
                                    <a target="_blank" href="https://github.com/geekhadev/laravel-admin-template/blob/main/CODE_OF_CONDUCT.md" className="text-sm text-balance text-orange-500 hover:text-orange-600">
                                        Código de conducta
                                    </a>
                                </div>
